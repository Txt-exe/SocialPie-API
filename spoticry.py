...
def follw_artist(artistpage):
    ...
    follow = webdriver.find_element_by_xpath('//*[@id="main"]/div/div[2]/div[3]/div[1]/div[2]/div[2]/div/div/div[2]/main/section/div/div[2]/div[2]/div[4]/div/div/div/div/button[1]')
    follow.click()
    time.sleep(3)
...
#Goes through accounts until all are used
    ...
    #Closes trust function window
        ...
        #Plays Desired Track
        playbutton = webdriver.find_element_by_xpath('//*[@id="main"]/div/div[2]/div[3]/div[1]/div[2]/div[2]/div/div/div[2]/main/section/div[3]/div[4]/div/div/div/div/div/button')
        playbutton.click()
    
        #Turns on repeat
        repeat = webdriver.find_element_by_xpath('//*[@id="main"]/div/div[2]/div[2]/footer/div/div[2]/div/div[1]/div[2]/button[2]')
        repeat.click()
        ...
        randomplay = webdriver.find_element_by_xpath('//*[@id="main"]/div/div[2]/div[3]/div[1]/div[2]/div[2]/div/div/div[2]/main/section/div/div[2]/div[2]/div[4]/div/div/div/div/div/button')
        randomplay.click()
        time.sleep(3)
    
        randomnize = webdriver.find_element_by_xpath('/html/body/div[4]/div/div[2]/div[2]/footer/div/div[2]/div/div[1]/div[1]/button[1]')
        randomnize.click()
        ...
        webdriver.get('https://www.spotify.com/us/account/overview/?utm_source=spotify&utm_medium=menu&utm_campaign=your_account')
        time.sleep(3)
        logout = webdriver.find_element_by_xpath('//*[@id="__next"]/div/div/div[2]/div[3]/div[2]/div/div[2]/article/div[2]/a')
        logout.click()
        print("Logged out")
